...
static __inline int list_empty(list_t *head)
{
	return head->next == head;
}

static __inline void __list_splice(list_t *list, list_t *head)
{
...
/**
* @param postype: the type of pos
* @param pos: the type * to use as a loop counter
* @param ntype: the type of n
* @param n: another type * to use as temporary storage
* @param head: the head for your list
* @param member: the name of the list_struct within the struct
*/
#define list_for_each_entry(postype, pos, ntype, n, head, member) \
for (pos = list_entry((head)->next, postype, member), \
	n = list_entry(pos->member.next, postype, member); \
	&(pos->member) != (head); \
	pos = n, n = list_entry(n->member.next, ntype, member))
...
*/
#define list_destroy(postype, pos, ntype, n, head, member, func) \
do { list_for_each_entry(postype, pos, ntype, n, &(head->list), member) { \
